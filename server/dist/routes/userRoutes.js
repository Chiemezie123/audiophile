...
const { getAllUsers, getUser, updateUser, updateMe, deleteMe, deleteUser, getMe, updateExistingDocuments, userUploadImage } = userController;
const { signUp, logIn, forgotPasswords, resetPassword, updatePassword, protect, restriction, logOut } = authController;
