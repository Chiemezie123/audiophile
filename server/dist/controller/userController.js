...
exports.deleteMe = catchAsync((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.user;
    if (!id)
...
exports.updateExistingDocuments = catchAsync((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
