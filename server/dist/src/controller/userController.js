...
export const updateExistingDocuments = catchAsync(async (req, res, next) => {
    const getResult = await User.updateMany({ isDeleted: { $exists: false } }, // Only update documents where isDeleted is missing
