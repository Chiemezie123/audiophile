...
const Header = ({ showCart, withBorder }: HeaderProps) => {
  return (
    <div
      className={`flex items-center justify-between z-1 py-8 ${
        withBorder
          ? "border-b-2 border-[var(--color-white)] border-opacity-20"
          : ""
      }`}
    >
      <svg
      ...
      <div className="text-[var(--color-white)]">audiophile</div>
      <ul className=" sm:hidden md:hidden lg:inline-flex gap-8.5 pr-0.5 justify-center items-start text-xs uppercase text-[var(--color-white)]">
        <li>Home</li>
        <li>Headphones</li>
        <li>Speakers</li>
        <li>Earphones</li>
