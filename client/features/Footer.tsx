  ...
  return (
    <footer>
      ...
      <div className="flex justify-between items-center mt-10">
        <p className="w-[540px] text-sm text-[var(--color-white)] opacity-50">
          Audiophile is an all in one stop to fulfill your audio needs. We're a
          small team of music lovers and sound specialists who are devoted to
          helping you get the most out of personal audio. Come and visit our
          demo facility - we're open 7 days a week.
        </p>
        <ul className="flex items-center gap-4 mt-10 text-[var(--color-white)]">
          <li>
            <svg
              width="24"
              height="24"
      ...
      <div className="mx-[165px] mt-8">
        <div className="text-[var(--color-white)] opacity-50 text-sm">
